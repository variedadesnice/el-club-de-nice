      ...
      >
        ...
        <div className="hidden md:flex md:col-span-7 bg-slate-900 rounded-[2.5rem] p-12 text-white relative overflow-hidden flex-col justify-between min-h-[400px]">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl font-black mb-6 leading-[1.1] tracking-tight">Recupera el<br />acceso a tu<br />cuenta.</h1>
            <p className="text-slate-400 text-lg font-medium max-w-sm">
              Ingresa tu email y, si tienes una cuenta con nosotros, te enviaremos un enlace para crear una nueva contraseña.
            </p>
          </div>
          ...
          <AnimatePresence mode="wait">
            {sent ? (
              ...
              >
                ...
                <h2 className="text-xl font-black text-slate-900 mb-2">Revisa tu correo</h2>
                <p className="text-sm font-medium text-slate-500 mb-8">
                  Si <span className="font-bold text-slate-700">{email}</span> está registrado, te enviamos un enlace para restablecer tu contraseña. Revisa también tu carpeta de spam.
                </p>
                <button
                  onClick={onGoToLogin}
              ...
              <motion.div key="form" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
                <h2 className="text-2xl font-black text-slate-900 mb-2">¿Olvidaste tu contraseña?</h2>
                <p className="text-sm font-medium text-slate-500 mb-8">
                  Escribe el email con el que te registraste y te enviaremos un enlace para recuperarla.
                </p>
